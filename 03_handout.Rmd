...
Knowing the basics for creating and wrapping functions is all we need to be able to make lifetables.
...
The first and key step is to transform a set of age-specific death rates into a set of age-specific probabilities of dying (${}_nq_x$). The relation between ${}_nM_x$ and ${}_nq_x$ have been established based on analyses of actual cohorts (for mathematical proof, see @preston2000demography, p. 42-43). 
...
1. Make your own lifetable function. Keep it somewhere you won't forget. Celebrate with a nice cup of tea. Or some other beverage.
