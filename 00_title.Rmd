...
This workshop was held daily from 1 July until until 5 July 2024 in situ in Seoul, South Korea, with the following daily themes:
...
If this workshop repeats in 2025, then the current contents will be saved in a snapshot *release* called `v2024` under the same web address. Currently previous releases include `v2021`, `v2022`, `v2023`.
