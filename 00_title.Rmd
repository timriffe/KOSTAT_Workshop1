...
If this workshop repeats in 2024, then the current contents will be saved in a snapshot *release* called `v2023` under the same web address. Currently previous releases include `v2021` and `v2022`.
