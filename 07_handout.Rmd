...
Today we will use tidy processing skills to age-standardize different demographic rates. We will also explain some demographic decomposition approaches, and see how these work well using the function-writing and tidy processing skills that we've learned so far.
