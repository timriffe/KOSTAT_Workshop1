...
Calculate the mean age at childbearing using fx as weights. Remember, weight together age + 1/2 rather than just age. Otherwise the result would be as if people only gave birth on their own birthdays? We use half, for half an interval, assuming, as demographers often do, that events happen midway into time intervals.
