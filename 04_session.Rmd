...
Periods rescaled, to see period-changes in structure (same as overlapping lines for cohort structure 2 plots ago)- these are stationary: proportional to the original Lx. i.e. with no extra *burden* of old vs young.
```{r}
stable |> 
  mutate(cohort = year - age) |> 
  filter(between(cohort, 0, 90)) |> 
