...
LT %>% 
  ...
  labs(title = "nqx Algeria, 2000",
       subtitle = "Data: GHO",
       caption ="The fact that the last two values are equal to 1 means that the nqx formula didn't work well.")
```
...
Let's save these results for potential use later in the workshop:

```{r}
AFR_LT %>% write_csv("Data/LT_results.csv")
```
